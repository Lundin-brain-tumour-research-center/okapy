...
def image_mask_preprocessor(path_to_img: pl.Path,
    ...
    Not supported:
        ...
        -> would require additional reference masked 'mask_list' to be passed to VolumeProcessor


    """
    img_sitk = sitk.ReadImage(path_to_img.as_posix())
    seg_sitk = sitk.ReadImage(path_to_mask.as_posix())
...
def preprocess_extract_features(path_to_img: pl.Path,
                                ...
                                p_out_features=None,
                                padding=10):
    p_img_proc, p_mask_proc = image_mask_preprocessor(path_to_img, path_to_mask, path_to_config,
